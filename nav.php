...
<div class="dropdown">
  <button class="dropbtn">
    ...
    <ul id="myUL">
        <li><a href="last part\xiaomiredminote8pro.php">Xiaomi Redmi Note 8 Pro</a></>
        <li><a href="last part\realmext.php">Realme XT</a></li>
        <li><a href="last part\redminote7pro.php">Redmi note 7 pro</a></li>
        <li><a href="last part\xiaomimia3.php">Xiaomi MI A3</a></li>
        <li><a href="last part\samsunggalaxym30.php">Samsung Galaxy M30</a></li>
        <li><a href="last part\samsunggalaxya50.php">Samsung Galaxy A50</a></li>
