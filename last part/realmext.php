  ...
  <?php include 'nav.php' ?>
    <main class="container">
      ...
      <div class="left-column">
        ...
        <img data-image="blue" class="active" src="images/xtb.jpg" alt="">
        <img data-image="white"  src="images/xtw.jpg" alt="">
      </div>
        ...
        <div class="product-configuration">
          ...
          <div class="product-color">
            ...
            <div class="color-choose">
         	...
         	<ul class="cd-features-list" type="none">
					<li>Price :₹15,999</li>
					<li>RAM : 4GB</li>
					<li>Screen Type : FHD+ Super AMOLED Display</li>
					<li>Battery : 4000 mAh </li>
					<li>Processor :  
            Qualcomm 712 Processor</li>
          ...
          <div class="cable-config">
            ...
            <div class="cable-choose">
              <button>4GB ₹15,999</button>
              <button>6GB ₹16,999</button>
            </div>
