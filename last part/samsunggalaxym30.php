  ...
  <?php include 'nav.php' ?>
    <main class="container">
      ...
      <div class="left-column">
        <img data-image="black" class="active" src="images/galaxym30b.jpg" alt="">
        <img data-image="blue"   src="images/m30w.jpg" alt="">
        ...
        <div class="product-configuration">
          ...
          <div class="product-color">
            ...
            Quad Core 675</li>
					...
					<li>Operating system : Oreo 8.0</li>
					<li>USB Type : C</li>
					<li>Processor speed : 
            1.8 GHz</li>
				</ul>
