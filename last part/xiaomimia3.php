  ...
  <?php include 'nav.php' ?>
    <main class="container">
      ...
      <div class="left-column">
        <img data-image="black" src="images/a3g.jpg" alt="">
        <img data-image="blue" src="images/a3b.jpg" alt="">
        <img data-image="white" class="active" src="images/a3w.jpg" alt="">
        ...
        <div class="product-configuration">
          ...
          <div class="product-color">
            ...
            <div class="color-choose">
         	...
         	<ul class="cd-features-list" type="none">
					<li>Price :₹ 12,999</li>
					<li>RAM : 4GB</li>
					<li>Screen Type : AMOLED Display</li>
					<li>Battery :4030 mAh </li>
					<li>Processor:  
            Qualcomm Snapdragon 665 octa core processor</li>
					<li>In built storage : 64 GB ROM | Expandable Upto 256 GB</li>
					<li>Operating system : Oreo 9.0</li>
					<li>USB Type : C</li>
					<li>Processor speed : 
            2.0GHz </li>
				</ul>
          ...
          <div class="cable-config">
            ...
            <div class="cable-choose">
              <button>4GB ₹12,999.00</button>
              <button>6GB ₹15,999</button>
            </div>
